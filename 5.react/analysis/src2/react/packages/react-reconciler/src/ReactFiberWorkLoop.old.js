...
export function scheduleUpdateOnFiber(
  ...
  if (lane === SyncLane) {
    if (
      ...
      console.log('render', executionContext); //sy-log
    } else {
      console.log('set-State', executionContext); //sy-log
...
function ensureRootIsScheduled(root: FiberRoot, currentTime: number) {
  ...
  if (newCallbackPriority === SyncLanePriority) {
    // ! setState
    console.log('setState', newCallbackPriority, SyncLanePriority); //sy-log
